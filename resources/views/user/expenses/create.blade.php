        ...
        <form id="expenseForm" action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="category_id" id="category_id"
                    ...
                    @foreach ($categories as $category)
                        <option value="{{ $category->id }}" data-tax="{{ $category->tax_percentage }}">{{ $category->name }}
                        </option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="amount" id="amount" required
                    class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm" onchange="calculateTotals()">
                @error('amount')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="tax_percentage" id="tax_percentage"
                    class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm" readonly>
            </div>
            ...
            <!-- Images section -->
            <div class="mb-4">
                <label for="images" class="block text-sm font-medium text-gray-700">Files:</label>
                <div id="imageInputs">
